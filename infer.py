...
st.title('Abhi Micro Instruct LM')
...
@st.cache_resource
def load_model():
    return keras_nlp.models.CausalLM.from_preset(f'kaggle://abhionic/gpt2/keras/gpt2_it')
...
# react to user input
if prompt := st.chat_input('what is up (experimental)?'):
